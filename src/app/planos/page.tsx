        ...
        <div className="container mx-auto px-4">
          ...
          <div id="pricing-table" className="max-w-7xl mx-auto px-2 md:px-4">
            {isStripeConfigured ? (
              ...
              <div className="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-8 text-center max-w-2xl mx-auto">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  Tabela de Preços Temporariamente Indisponível
                </h3>
                <p className="text-gray-600 mb-6">
                  A configuração do Stripe está pendente. Entre em contato via WhatsApp para conhecer nossos planos e fazer sua assinatura.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a
                    href="https://wa.me/5533999898026?text=Olá!%20Gostaria%20de%20conhecer%20os%20planos%20de%20assinatura."
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition-colors shadow-md"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-cyan-600 text-white font-semibold rounded-lg hover:bg-cyan-700 transition-colors shadow-md"
                  >
                ...
                <p className="text-sm text-gray-500 mt-4">
                  Administradores: Configure a variável <code className="bg-gray-100 px-2 py-1 rounded">NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY</code> no arquivo .env.local
                </p>
              </div>
            )}
          </div>
