...
import { AppointmentsPanel } from '@/components/assinante/AppointmentsPanel'
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Consultas e Agendamentos</h1>
              <p className="text-sm text-gray-600">Gerencie seus agendamentos médicos</p>
            </div>
          </div>
        </div>
      </header>
