...
const nextConfig = {
    ...
    eslint: {
        // Ignore ESLint errors during build to unblock production
  ...
  // Turbopack removed for Next.js 14 compatibility
    // turbopack: {},
    ...
    headers: async () => {
        ...
        const cspDirectives = isDev
            ? [
                "default-src 'self'",
                "script-src 'self' 'unsafe-eval' 'unsafe-inline' data: *.asaas.com accounts.google.com apis.google.com *.gstatic.com js.stripe.com *.stripe.com checkout.stripe.com *.facebook.com *.facebook.net securetoken.googleapis.com firebase.googleapis.com www.googletagmanager.com www.google-analytics.com *.clerk.accounts.dev *.clerk.com clerk.svlentes.com.br",
                ...
                "frame-src 'self' *.firebaseapp.com accounts.google.com oauth2.googleapis.com js.stripe.com *.stripe.com checkout.stripe.com *.facebook.com www.facebook.com *.clerk.accounts.dev *.clerk.com",
                "frame-ancestors 'self'",
                "form-action 'self' accounts.google.com js.stripe.com checkout.stripe.com",
                "object-src 'none'",
                "base-uri 'self'",
            ]
            : [
                "default-src 'self'",
                "script-src 'self' 'unsafe-inline' 'unsafe-eval' *.asaas.com accounts.google.com apis.google.com *.gstatic.com js.stripe.com *.stripe.com checkout.stripe.com *.facebook.com *.facebook.net securetoken.googleapis.com firebase.googleapis.com www.googletagmanager.com www.google-analytics.com *.clerk.accounts.dev *.clerk.com clerk.svlentes.com.br",
